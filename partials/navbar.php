<nav id="nav-header" class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
        <a class="navbar-brand" href="index.php"><i class="fa fa-bandcamp" aria-hidden="true"></i>TB Phone</a>
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
            ...
            <ul class="navbar-nav ml-auto mt-2 mt-lg-0">
                <li class="nav-item text-nav-item ">
                    <a class="nav-link text-white hover-btn" href="#">
                        ...
                        if ($_SESSION['user'] == 'admin') {
                            echo '<li class="dropdown" ><a href="#" class="dropdown-toggle nav-link text-white hover-btn" data-toggle="dropdown">' . $_SESSION['user'] . '<span class="caret"></span></a>
                                            <ul class="dropdown-menu" style="font-size: 15px;">
                                                <li align= "center" ><a href="admin.php" style="text-decoration:none">Quản lý sản phẩm</a></li>
